...
6. [Производительность модели](#Производительность-модели)
7. [Расписание пайплайна](#Расписание-пайплайна)
8. [Возможности дашборда (на данный момент)](#Возможности-дашборда-(на-данный-момент))
